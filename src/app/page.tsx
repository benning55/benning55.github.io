    ...
    <main className='min-h-screen'>
            ...
            {[
              {
                ...
                icon: Mail,
                text: "bmaisonti@gmail.com",
              },
              {
                href: "https://linkedin.com/in/sedthawuth-benning",
                icon: Linkedin,
                text: "linkedin.com/in/sedthawuth-benning",
              },
                ...
                <ul className='space-y-3 mb-4'>
                  {job.achievements.map((achievement, achievementIndex) => (
                    <motion.li
                      ...
                      viewport={{ once: true }}
                      transition={{
                        delay: index * 0.2 + achievementIndex * 0.1 + 0.4,
                        duration: 0.5,
                      }}
      ...
      <footer className='py-8 text-center text-muted-foreground'>
        <div className='container px-4 mx-auto'>
          <p>
            © {new Date().getFullYear()} Sedthawuth Maisonti. All rights
            reserved.
          </p>
        </div>
      </footer>
